...
<a href=https://drive.google.com/file/d/1_uWULEMUtOCEvVsW37oDQ8FfDYfqPtaD/view target="_blank">tobas_2.12.1_amd64.deb</a>
をダウンロードしてください．
...
$ cd ~/Download
$ gdown --fuzzy 'https://drive.google.com/file/d/1_uWULEMUtOCEvVsW37oDQ8FfDYfqPtaD/view'
```
...
```bash
$ sudo dpkg -i tobas_2.12.1_amd64.deb
```
...
<a href=https://drive.google.com/file/d/1AQrlflXrzHHWTSINe-fhn0lPM0SKjGd5/view target="_blank">tobas_2.12.1_arm64.img.gz</a>
をダウンロードしてください．
...
$ sudo pip install gdown --break-system-packages
$ cd ~/Download
$ gdown --fuzzy 'https://drive.google.com/file/d/1AQrlflXrzHHWTSINe-fhn0lPM0SKjGd5/view'
```
...
$ gunzip tobas_2.12.1_arm64.img.gz
```
...
```bash
$ sudo dd if=tobas_2.12.1_arm64.img of=/dev/sdx bs=4M conv=fsync status=progress
```
