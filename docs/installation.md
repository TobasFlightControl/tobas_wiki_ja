...
<a href=https://drive.google.com/file/d/1bDhWy58Errc2Mpa0pUnV3aL5PvBl8na6/view target="_blank">tobas_2.12.0_amd64.deb</a>
をダウンロードしてください．
...
$ cd ~/Download
$ gdown --fuzzy 'https://drive.google.com/file/d/1bDhWy58Errc2Mpa0pUnV3aL5PvBl8na6/view'
```
...
```bash
$ sudo dpkg -i tobas_2.12.0_amd64.deb
```
...
<a href=https://drive.google.com/file/d/1sNRAo2wEWUWVHAPP4RlLmxxMQOKuITB6/view target="_blank">tobas_2.12.0_arm64.img.gz</a>
をダウンロードしてください．
...
$ sudo pip install gdown --break-system-packages
$ cd ~/Download
$ gdown --fuzzy 'https://drive.google.com/file/d/1sNRAo2wEWUWVHAPP4RlLmxxMQOKuITB6/view'
```
...
$ gunzip tobas_2.12.0_arm64.img.gz
```
...
```bash
$ sudo dd if=tobas_2.12.0_arm64.img of=/dev/sdx bs=4M conv=fsync status=progress
```
